...
const midtransCstController = {
  createMidtrans: async (req, res) => {
    try {
      const { user_id, updated_at, midtrans_customer_id } = req.body
  ...
  updateMidtrans: async (req, res) => {
    try {
      const { id } = req.params
      const { updated_at, midtrans_customer_id } = req.body
...
module.exports = midtransCstController
